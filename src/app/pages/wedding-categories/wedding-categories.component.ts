...
@Component({
  selector: 'app-wedding-categories',
  templateUrl: './wedding-categories.component.html',
  styleUrls: ['./wedding-categories.component.scss']
})
export class WeddingCategoriesComponent {
  selectedIndex: any;
  select: any;
  categoryID!: number;
