...
export class OffersComponent {
  ...
  constructor(private route: Router, private api: ApiService, private spinner: NgxSpinnerService) {
    this.pro();
  ...
  pro() {
    this.api.get(`ecom/products`)
      .subscribe((res: any) => {
        this.allpro = res;
        console.log("producteall....", this.allpro)
        this.douing();
